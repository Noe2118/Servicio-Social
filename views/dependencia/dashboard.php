...
<aside class="sidebar">
    ...
    <ul class="sidebar-nav">
        <li><a href="<?= BASE_URL ?>/dependencia/dashboard" class="active"><i class="fa-regular fa-rectangle-list"></i> Dashboard</a></li>
        <li><a href="<?= BASE_URL ?>/dependencia/misProgramas"><i class="fa-regular fa-folder-open"></i> Mis Programas</a></li>
        <li><a href="<?= BASE_URL ?>/dependencia/alumnos"><i class="fa-regular fa-address-book"></i> Alumnos y Evaluaciones</a></li>
    </ul>
